...
describe('total likes', () => {
  ...
  test('of list with multiple blogs is correct', () => {
    const result = listHelper.totalLikes(nBlogs)
...
describe('favourite blog', () => {
  ...
  test('correct blogger returned with n blogs', () => {
    const result = listHelper.favouriteBlog(nBlogs)
...
describe('Most blogs', () => {
  ...
  test('author with most blogs is correct with n amount of blogs', () => {
    ...
    const result = listHelper.mostBlogs(nBlogs)
...
describe('blogger with most likes', () => {
  ...
  test('correct blogger returned with n blogs', () => {
    const result = listHelper.mostLikes(nBlogs)
